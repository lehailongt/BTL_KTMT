...
sang_phai:                          
    ...
    check:                          ;kiem tra con ran co cham hang rao, dam than chinh no hay an tao khong 
        ...
        cmp al, hinh_tao                 ;so sanh ki tu voi ki tu qua tao
        je an_apple                       ;neu khong thi chua an duoc qua tao
        cmp al, hinh_kc
        je an_kc
...
sinh_kc proc
    lap_sinh_kc: 
    ngau_nhien begin_row, end_row, kc_x            ;tao toa_do_x cua qua tao
    ngau_nhien begin_column, end_column, kc_y      ;tao toa_do_y cua qua tao
    di_chuyen_con_tro kc_x, kc_y
    mov ah, 8
    mov bh, 0
    int 10h
    cmp al, 'X'
    ...
    je lap_sinh_kc
    cmp al, hinh_kc 
    gan_toa_do kc_x, kc_y, hinh_kc                    ;in ra qua tao moi
    ret
sinh_kc endp
...
in_ran proc                                
    ...
    je ket                                ;thuc hien in dau con ran
